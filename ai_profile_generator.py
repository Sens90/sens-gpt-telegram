...
def generate_scene(player,category="random",logo_path="assets/titani_logo.jpg"):
    ...
    full_prompt=(prompt+" La PRIMA immagine allegata e la reference visiva obbligatoria del Brawler: mantieni il personaggio fedele. La SECONDA immagine allegata e il LOGO ORIGINALE TITANI ABUSIVI: deve comparire riconoscibile e fedele, ma INTEGRATO FISICAMENTE NEL CONTESTO DELLA SCENA, non appoggiato come watermark o badge. In base all'ambientazione trasformalo in modo naturale in un'insegna, bandiera, stendardo, incisione, graffiti, ologramma, schermo, stemma su muro/edificio, tessuto o altro elemento scenografico coerente. Mantieni forma, simbolo, scritte e identita del logo originale; non sostituirlo con un logo inventato. Deve essere ben visibile ma non coprire il Brawler. "+_profile_data_prompt(player)+" Nome, tag, club e statistiche devono essere integrati nella composizione come tipografia ambientale/HUD leggero, senza grandi riquadri, card, pannelli neri o cornici. Il Brawler resta protagonista. Per icone e marchi ufficiali Brawl Stars non inventare imitazioni: usa solo riferimenti ufficiali disponibili; se non disponibili, ometti l'icona.")
