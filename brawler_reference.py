...
def _apply_brawler(player,brawler):
    ...
    player["profile_brawler"]=brawler.get("name"); player["profile_brawler_id"]=brawler.get("id"); player["profile_brawler_image_url"]=image; return True
...
def resolve_ai_brawler_reference(player,requested_brawler=None,timeout=15):
    try:
        ...
        if requested_brawler:
            ...
            # Compatibilita immediata con il parser corrente: "con BRAWLER ambientazione LUOGO".
            # Il luogo viene conservato nel player e letto dal generatore.
        ...
        print("AI BRAWLER REFERENCE:",repr(exc),flush=True); return False,"Riferimento Brawler temporaneamente non disponibile."
